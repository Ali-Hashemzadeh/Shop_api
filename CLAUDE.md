...
**Test suite baseline: 294 tests + 55 Shipment tests + 31 Notification/Sms tests, all green (5 unrelated pre-existing ProfileTest/ProductsTest failures aside).**
